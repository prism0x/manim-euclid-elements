...
class Introduction(VoiceoverScene):
    def construct(self):
        ...
        text3 = Tex(
            r"\textsf{This project evolves continuously, and we hope that it will set an example in making the world's knowledge more accessible. You can find the source under \texttt{github.com/mathblocks/manim-euclid-elements}}",
            font_size=36,
        )
